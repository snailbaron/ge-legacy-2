...
TEST_CASE("Simple", "[simple]")
{
    ...
    ge::thing::EntityManager manager;
...
TEST_CASE("Get component pack", "[component]")
{
    ...
    auto sum = [] (const ge::thing::EntityManager& manager) {
        int sum = 0;
    ...
    auto concat = [] (const ge::thing::EntityManager& manager) {
        std::string concat;
...
{
    const ge::thing::EntityManager manager;
